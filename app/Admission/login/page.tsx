      ...
      <div className="grid grid-cols-1 md:grid-cols-2 w-full max-w-5xl shadow-lg rounded-lg overflow-hidden relative">
        <form onSubmit={handleSubmit} className="bg-white p-10">
          ...
          <div className="flex justify-between items-center mb-2">
            ...
            <Link href="/Admission/signup" className="text-blue-700 text-sm ml-2 whitespace-nowrap">
              Forgot password?
            </Link>
          </div>
          ...
          <p className="text-sm text-center mt-4">
            Don’t have an account? <Link href="/Admission/signup" className="text-blue-700">Sign up</Link>
          </p>
        </form>
